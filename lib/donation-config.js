...
export const DONATION_MILESTONES = [
  { amount: 2500, label: "Financial Assistance Fund" },
  { amount: 5000, label: "Financial Assistance + Equipment Fund" },
  { amount: 7500, label: "Financial Assistance + Equipment Expansion" },
  { amount: 10000, label: "Smash Attack Volleyball Machine + Financial Assistance" },
];
